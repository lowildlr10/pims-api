...
Route::middleware('auth:sanctum')->group(function () {
    Route::name('inspection_acceptance_reports.')->prefix('/inspection-acceptance-reports')->group(function () {
        ...
        Route::put('/{inspectionAcceptanceReport}', [MainControllers\InspectionAcceptanceReportController::class, 'update'])
            ...
            ->name('update');
        Route::put('/{inspectionAcceptanceReport}/for-inspection', [MainControllers\InspectionAcceptanceReportController::class, 'forInspection'])
            ->middleware('ability:super:*,supply:*,iar:*,iar:for-inspection')
            ->name('for-inspection');
