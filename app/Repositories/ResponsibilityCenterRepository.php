...
class ResponsibilityCenterRepository implements ResponsibilityCenterRepositoryInterface
{
    public function __construct(protected ResponsibilityCenter $model) {}

    public function getModel(): string
    {
        return ResponsibilityCenter::class;
    }
