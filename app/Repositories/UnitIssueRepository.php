...
class UnitIssueRepository implements UnitIssueRepositoryInterface
{
    public function __construct(
        protected UnitIssue $model
    ) {}

    public function getModel(): string
    {
        return UnitIssue::class;
    }
    ...
    public function getAll(array $filters): LengthAwarePaginator
    {
        ...
        $columnSort = $filters['column_sort'] ?? 'unit_name';
