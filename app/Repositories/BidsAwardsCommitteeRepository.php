...
class BidsAwardsCommitteeRepository implements BidsAwardsCommitteeRepositoryInterface
{
    public function __construct(protected BidsAwardsCommittee $model) {}

    public function getModel(): string
    {
        return BidsAwardsCommittee::class;
    }
    ...
    public function getAll(array $filters): LengthAwarePaginator
    {
        ...
        $columnSort = $filters['column_sort'] ?? 'committee_name';
