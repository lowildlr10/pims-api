...
class DisbursementVoucherResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'tax_withholding_id' => $this->tax_withholding_id,
            'tax_withholding' => $this->whenLoaded('tax_withholding', fn () => new TaxWithholdingResource($this->tax_withholding)),
            ...
            'gross_amount_formatted' => number_format($this->gross_amount, 2),
