...
Route::middleware('auth:sanctum')->prefix('/libraries')->group(function() {
    ...
    Route::name('funding-sources.')->prefix('/funding-sources')->group(function () {
        ...
        Route::put('/{fundingSource}', [LibraryControllers\FundingSourceController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{fundingSource}', [LibraryControllers\FundingSourceController::class, 'delete'])
            ->middleware('ability:super:*,lib-fund-source:*,lib-fund-source:delete')
            ->name('delete');
    });
    ...
    Route::name('item-classifications.')->prefix('/item-classifications')->group(function () {
        ...
        Route::put('/{itemClassification}', [LibraryControllers\ItemClassificationController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{itemClassification}', [LibraryControllers\ItemClassificationController::class, 'delete'])
            ->middleware('ability:super:*,lib-item-class:*,lib-item-class:delete')
            ->name('delete');
    });
    ...
    Route::name('mfo-paps.')->prefix('/mfo-paps')->group(function () {
        ...
        Route::put('/{mfoPap}', [LibraryControllers\MfoPapController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{mfoPap}', [LibraryControllers\MfoPapController::class, 'delete'])
            ->middleware('ability:super:*,lib-mfo-pap:*,lib-mfo-pap:delete')
            ->name('delete');
    });
    ...
    Route::name('procurement-modes.')->prefix('/procurement-modes')->group(function () {
        ...
        Route::post('/', [LibraryControllers\MfoPapController::class, 'store'])
            ...
            ->name('store');
        Route::get('/{modeProcurement}', [LibraryControllers\MfoPapController::class, 'show'])
            ->middleware('ability:super:*,lib-mode-proc:*,lib-mode-proc:view')
            ->name('show');
        Route::put('/{modeProcurement}', [LibraryControllers\MfoPapController::class, 'update'])
            ->middleware('ability:super:*,lib-mode-proc:*,lib-mode-proc:update')
            ->name('update');
        Route::delete('/{modeProcurement}', [LibraryControllers\MfoPapController::class, 'delete'])
            ->middleware('ability:super:*,lib-mode-proc:*,lib-mode-proc:delete')
            ->name('delete');
    });
    ...
    Route::name('signatories.')->prefix('/signatories')->group(function () {
        ...
        Route::put('/{signatory}', [LibraryControllers\SignatoryController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{signatory}', [LibraryControllers\SignatoryController::class, 'delete'])
            ->middleware('ability:super:*,lib-signatory:*,lib-signatory:delete')
            ->name('delete');
    });
    ...
    Route::name('suppliers.')->prefix('/suppliers')->group(function () {
        ...
        Route::put('/{supplier}', [LibraryControllers\SupplierController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{supplier}', [LibraryControllers\SupplierController::class, 'delete'])
            ->middleware('ability:super:*,lib-supplier:*,lib-supplier:delete')
            ->name('delete');
    });
    ...
    Route::name('uacs-code-classifications.')->prefix('/uacs-code-classifications')->group(function () {
        ...
        Route::put('/{uacsCodeClassification}', [LibraryControllers\UacsCodeClassificationController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{uacsCodeClassification}', [LibraryControllers\UacsCodeClassificationController::class, 'delete'])
            ->middleware('ability:super:*,lib-uacs-class:*,lib-uacs-class:delete')
            ->name('delete');
    });
    ...
    Route::name('uacs-codes.')->prefix('/uacs-codes')->group(function () {
        ...
        Route::put('/{uacsCode}', [LibraryControllers\UacsCodeController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{uacsCode}', [LibraryControllers\UacsCodeController::class, 'delete'])
            ->middleware('ability:super:*,lib-uacs-code:*,lib-uacs-code:delete')
            ->name('delete');
    });
    ...
    Route::name('unit-issues.')->prefix('/unit-issues')->group(function () {
        ...
        Route::put('/{unitIssue}', [LibraryControllers\UnitIssueController::class, 'update'])
            ...
            ->name('update');
        Route::delete('/{unitIssue}', [LibraryControllers\UnitIssueController::class, 'delete'])
            ->middleware('ability:super:*,lib-unit-issue:*,lib-unit-issue:delete')
            ->name('delete');
    });
});
