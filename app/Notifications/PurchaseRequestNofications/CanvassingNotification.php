...
class CanvassingNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'title' => 'Under Canvassing',
            'message' => "<q>Purchase Request - {$this->pr->pr_no}</q> with ".
                "<q>RFQ - {$this->rfq->rfq_no}</q> is currently undergoing canvassing of suppliers.",
        ];
    }
