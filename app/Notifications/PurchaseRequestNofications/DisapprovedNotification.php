...
class DisapprovedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => "<q>Purchase Request - {$this->data->pr_no}</q> has been disapproved and requires attention.",
        ];
    }
